...
6) Daans votre téléphone envoyer via whatsapp le message suivant : join correct-atom
   au nimero +14155238886 avant de commencez le tout premier message de commande 
8) placez à la racine du projet flutter pour le mobile
9) à l'aide de votre terminal  tapez flutter run si vous avez flutter configurer sinon il faut faire l'installation
10) 
